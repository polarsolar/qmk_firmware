...
[_DVORAK] = LAYOUT (
  KC_GESC, KC_1,    KC_2,    KC_3,    F(1),    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LBRC, KC_RBRC, KC_BSPC, KC_DEL,           TD(TD_U_H),
  ...
  */
[_QWERTY] = LAYOUT (
  KC_GESC, KC_1,    KC_2,    KC_3,    F(1),    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_DEL,           TD(TD_U_H),
